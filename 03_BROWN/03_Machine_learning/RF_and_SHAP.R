...
dirs <- c(
  "03_BROWN/Figs/MachineLearning",
  "03_BROWN/Figs/MachineLearning/Depth",
  "03_BROWN/Figs/MachineLearning/Magnitude",
  "03_BROWN/Figs/MachineLearning/SHAP_interaction/Depth",
  "03_BROWN/Figs/MachineLearning/SHAP_interaction/Magnitude"
)
...
ggsave(
  filename = here::here("03_BROWN/Figs", "MachineLearning", "Met_combinedRF.png"),
...
depth_jackknife_over20 <- jackknife_incMSE_heatmap(
  ...
  response_var   = "DCM_depth",
  whichvars_label= "",
  save_path      = here::here("03_BROWN", "Figs","MachineLearning","Depth","Jackknife_Heatmap_over20.png"), 
  variable_labels = variable_labels, 
  panel_label = "A"
)
...
magnitude_jackknife <- jackknife_incMSE_heatmap(
  ...
  response_var   = "max_conc",
  whichvars_label= "",
  save_path      = here::here("03_BROWN","Figs","MachineLearning","Magnitude","MagnitudeJackknife_Heatmap.png"), 
  variable_labels = variable_labels, 
  panel_label = "B"
)
#if you want to view
...
ggsave(
  filename = here::here("03_BROWN","Figs", "MachineLearning", "FinalCombined_Depth_Magnitude_RF.png"),
  plot = combined_RF_panels,
  width = 18, height = 10, dpi = 600, bg = "white"
)
...
plot_shap_vs_value_loop(
  ...
  out_dir = here::here("03_BROWN/Figs/MachineLearning/SHAP_interaction/Depth"),
  prefix = "depth",
...
plot_shap_vs_value_loop(
  ...
  vars_to_plot = vars_to_plot,
  out_dir = here::here("03_BROWN/Figs/MachineLearning/SHAP_interaction/Magnitude"),
  prefix = "magnitude",
