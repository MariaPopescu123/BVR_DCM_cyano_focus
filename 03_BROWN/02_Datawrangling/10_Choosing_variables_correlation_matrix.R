...
full_weekly_data <- read.csv("03_BROWN/CSVs/full_weekly_data.csv")

if (!dir.exists("03_BROWN/Figs/correlations")){
  dir.create("03_BROWN/Figs/correlations")
}
...
check <- plot_correlation_matrix(
  full_weekly_data,
  "03_BROWN/Figs/correlations/full_corr_Matrix.png",
  title = "Correlation Matrix Heatmap for Variable Selection - Brown Algae",
...
ggsave(
  filename = "03_BROWN/Figs/correlations/thermal_pairing_table.png",
  plot = tbl_grob,
