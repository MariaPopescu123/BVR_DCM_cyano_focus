...
if (!dir.exists("03_BROWN/Figs/metdata")) {
  dir.create("03_BROWN/Figs/metdata", recursive = TRUE)
}
...
print(combined_plot)
ggsave("03_BROWN/Figs/metdata/NLDAS.png", combined_plot, width = 12, height = 8, dpi = 300)
