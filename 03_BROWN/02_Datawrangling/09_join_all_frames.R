...
#read in csvs
frame_weeks <- read.csv("03_BROWN/CSVs/frame_weeks.csv")
final_phytos <- read.csv("03_BROWN/CSVs/final_phytos.csv")
final_metals <- read.csv("03_BROWN/CSVs/final_metals.csv")|>
  select(-Date)
final_photic_thermo <- read.csv("03_BROWN/CSVs/final_photic_thermo.csv")|>
  select(-Date)
final_buoyancy <- read.csv("03_BROWN/CSVs/final_buoyancy.csv")
final_chem <- read.csv("03_BROWN/CSVs/final_chem.csv")|>
  select(-Date)
final_schmidt <- read.csv("03_BROWN/CSVs/final_schmidt.csv")
...
write.csv(full_weekly_data, "03_BROWN/CSVs/full_weekly_data.csv", row.names = FALSE)
