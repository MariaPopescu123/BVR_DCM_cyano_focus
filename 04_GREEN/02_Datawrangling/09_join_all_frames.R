...
#read in csvs
frame_weeks <- read.csv("04_GREEN/CSVs/frame_weeks.csv")
final_phytos <- read.csv("04_GREEN/CSVs/final_phytos.csv")
final_metals <- read.csv("04_GREEN/CSVs/final_metals.csv")|>
  select(-Date)
final_photic_thermo <- read.csv("04_GREEN/CSVs/final_photic_thermo.csv")|>
  select(-Date)
final_buoyancy <- read.csv("04_GREEN/CSVs/final_buoyancy.csv")
final_chem <- read.csv("04_GREEN/CSVs/final_chem.csv")|>
  select(-Date)
final_schmidt <- read.csv("04_GREEN/CSVs/final_schmidt.csv")
...
write.csv(full_weekly_data, "04_GREEN/CSVs/full_weekly_data.csv", row.names = FALSE)
