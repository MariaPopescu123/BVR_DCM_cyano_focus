...
if (!dir.exists("04_GREEN/Figs/metdata")) {
  dir.create("04_GREEN/Figs/metdata", recursive = TRUE)
}
...
print(combined_plot)
ggsave("04_GREEN/Figs/metdata/NLDAS.png", combined_plot, width = 12, height = 8, dpi = 300)
