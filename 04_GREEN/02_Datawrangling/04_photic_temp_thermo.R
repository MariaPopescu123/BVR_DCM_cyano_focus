...
if (!dir.exists("04_GREEN/Figs/Daily_interp_Casts")) {
  dir.create("04_GREEN/Figs/Daily_interp_Casts", recursive = TRUE)
}
...
#will save figures to these files
if (!dir.exists("04_GREEN/Figs/Thermocline")) {
  dir.create("04_GREEN/Figs/Thermocline", recursive = TRUE)
}
...
write.csv(photic_zone_frame, "04_GREEN/CSVs/photic_zone_frame.csv", row.names = FALSE)
...
for (yr in years) {
  ...
  # Save plot
  ggsave(filename = paste0("04_GREEN/Figs/Daily_interp_Casts/", yr, "_raw_casts.png"),
         plot = plot_casts,
         width = 12,
         height = 10,
         dpi = 300)
...
for (yr in years) {
  ...
  # Save plot
  ggsave(filename = paste0("04_GREEN/Figs/Thermocline/", yr, "_raw_casts.png"),
         plot = plot_casts,
         width = 12,
         height = 10,
         dpi = 300)
...
write.csv(final_photic_thermo, "04_GREEN/CSVs/final_photic_thermo.csv", row.names = FALSE)
