...
ggsave(
  filename = "02_CYANOS/Figs/Phytos_viz/final_phytos_heatmap_plot.png",
...
ggsave("02_CYANOS/Figs/Phytos_viz/FP_casts_2025_just_totals.png",
       plot = plot_casts,
...
ggsave("02_CYANOS/Figs/Phytos_viz/FP_casts_2025.png",
       plot = plot_casts,
       width = 13, height = 7, units = "in",
       dpi = 300)  # high-res
