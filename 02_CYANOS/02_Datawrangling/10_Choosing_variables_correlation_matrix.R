...
full_weekly_data <- read.csv("02_CYANOS/CSVs/full_weekly_data.csv")

if (!dir.exists("02_CYANOS/Figs/correlations")){
  dir.create("02_CYANOS/Figs/correlations")
}
...
check <- plot_correlation_matrix(
  full_weekly_data,
  "02_CYANOS/Figs/correlations/full_corr_Matrix.png",
  title = "Correlation Matrix Heatmap for Variable Selection - Bluegreens",
...
ggsave(
  filename = "02_CYANOS/Figs/correlations/thermal_pairing_table.png",
  plot = tbl_grob,
